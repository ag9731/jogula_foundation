  ...
  return (
    <>
      <div className="flex w-[90%] mx-auto flex-col gap-16">
        <div className="Section2cards flex gap-40 justify-center items-center">
        ...
        <div className="flex justify-around align-content-center items-center">
          <div className="desc flex flex-col gap-6 font-semibold text-lg justify-center w-[50%]">
            <h1 className="text-3xl font-medium	">JOGULA NGO</h1>
